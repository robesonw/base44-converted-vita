      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          <div className="text-center">
            <Badge className="mb-6 bg-white/20 text-white border-white/30 backdrop-blur-sm">✨ AI-Powered Health & Nutrition Platform</Badge>
            <h1 className="text-5xl md:text-7xl font-bold mb-6">
              Welcome to VitaPlate<br />
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="bg-white text-indigo-600 hover:bg-white/90 shadow-xl text-lg px-8 py-6" onClick={() => router.push('/HealthDietHub')}>Get Started Free<ArrowRight className="ml-2 w-5 h-5" /></Button>
              <Button asChild size="lg" className="bg-white/20 backdrop-blur-md text-white border-2 border-white hover:bg-white hover:text-indigo-600 text-lg px-8 py-6" onClick={() => router.push('/Dashboard')}>View Dashboard</Button>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-b from-slate-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">Powerful features designed to make healthy eating simple and sustainable</p>
          </div>
